      ...
      children: [
        {
          ...
          description: [
            "Project Title: Connect and Empower",
            "Location: President University",
            "Duration: 7 Weeks",
            "Type: Group Project",
            "Overview:",
            "Connect and Empower was a collaborative 7-week project designed to foster meaningful connections among university students while enhancing their English communication skills.",
            "The project aimed to build a supportive learning environment where participants could engage, share ideas, and develop confidence in using English in academic and social contexts.",
            "Project Structure:",
            "The sessions were carefully structured into three main components:",
            "Warm-up Activities: Interactive games and icebreakers were used at the beginning of each session to create a relaxed atmosphere, encourage participation, and build rapport among students from different universities.",
            "Facilitators’ Presentation: Each session included presentations delivered by facilitators on relevant topics, focusing on communication skills, collaboration, and language use.",
            "Discussion Sessions: Participants engaged in guided discussions, allowing them to practice English actively, exchange perspectives, and strengthen their critical thinking and interpersonal skills.",
            "Objectives:",
            "To create networking opportunities among students from different universities",
            "To improve English language proficiency through interactive learning",
            "To build confidence in communication and teamwork",
            "Outcome and Achievement:",
            "The project was successfully implemented and received positive engagement from participants.",
            "It was recognized for its impact and innovation, earning 2nd Prize among competing projects.",
            "Reflection:",
            "This project strengthened my ability to design and facilitate interactive learning experiences, manage group dynamics, and support language development in a collaborative setting.",
            "It also enhanced my skills in teamwork, communication, and educational program planning.",
          ],
        },
        {
          id: 2,
      ...
      children: [
        {
          ...
          position: "top-5 left-10",
          description: [
            "Project Title: Exploring Indonesian Tea Culture",
            "Subject: Social Studies",
            "Level: Grade 4",
            "Type: Teaching Project",
            "Overview:",
            "This Social Studies project focused on introducing Grade 4 students to the diversity of Indonesian tea.",
            "The project aimed to build students’ cultural awareness while integrating hands-on learning and interactive classroom engagement.",
            "Project Structure:",
            "The lesson was designed in three main stages:",
            "Structured Presentation: The lesson began with a teacher-led presentation introducing different types of tea in Indonesia, including their origins, characteristics, and cultural significance.",
            "Hands-on Activities: Students participated in interactive activities such as making tea based on the instructions given, identifying differences in taste and aroma, and discussing their findings in groups.",
            "Gallery Walk: Students created simple displays based on what they learned and participated in a gallery walk, where they observed each other’s work, asked questions, and shared ideas.",
            "Objectives:",
            "To introduce students to the variety of tea in Indonesia",
            "To develop students’ observation and inquiry skills",
            "To encourage collaborative learning and communication",
            "To connect cultural knowledge with real-life experiences",
            "Outcome and Reflection:",
            "Students showed high engagement throughout the activities, especially during the hands-on and gallery walk sessions.",
            "The project successfully promoted active learning and helped students better understand Indonesian cultural products.",
            "This experience enhanced my ability to design interactive Social Studies lessons, integrate experiential learning strategies, and facilitate student-centered classroom activities.",
          ],
        },
        {
          id: 2,
          ...
          kind: "file",
          fileType: "img",
          imageUrl: "/images/social-studies-1.jpg",
          position: "top-10 right-20",
        },
        {
          id: 4,
          ...
          fileType: "img",
          position: "top-52 right-80",
          imageUrl: "/images/social-studies-2.jpg",
        },
        {
          id: 5,
          name: "memo-3",
          ...
          kind: "file",
          fileType: "img",
          imageUrl: "/images/social-studies-3.jpg",
          position: "top-60 right-20",
        },
      ],
    },
